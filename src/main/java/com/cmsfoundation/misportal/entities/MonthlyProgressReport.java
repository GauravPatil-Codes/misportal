...
public class MonthlyProgressReport {
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "monthly_target_item_id", nullable = false)
    private MonthlyTargetItem monthlyTargetItem;
    ...
    private void calculateDeviationAndPercentage() {
        if (monthlyTargetItem != null && achievedTarget != null) {
            Integer plannedTarget = monthlyTargetItem.getPlannedTarget();
    ...
    public MonthlyTargetItem getMonthlyTargetItem() { return monthlyTargetItem; }
    public void setMonthlyTargetItem(MonthlyTargetItem monthlyTargetItem) { this.monthlyTargetItem = monthlyTargetItem; }
    ...
    public Integer getNextMonthAdjustedTarget() { return nextMonthAdjustedTarget; }
    public void setNextMonthAdjustedTarget(Integer nextMonthAdjustedTarget) { this.nextMonthAdjustedTarget = nextMonthAdjustedTarget; }
